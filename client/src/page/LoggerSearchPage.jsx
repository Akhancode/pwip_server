      ...
      <table className={"tableData"+` `+`${status}`}>
        <tr>
          <th className="thead">
            ...
            <span onClick={()=>sortFunction("logID")} className="sort">⬇</span>
          </th>
          <th className="thead">
            <label htmlFor="">Application Type</label>
            <span onClick={()=>sortFunction("applicationType")} className="sort">⬇</span>
          </th>
          <th className="thead">
            <label htmlFor="">Application ID </label>
            <span onClick={()=>sortFunction("applicationId")} className="sort">⬇</span>
          </th>
          <th className="thead">
            <label htmlFor="">Action</label>
            <span  onClick={()=>sortFunction("actionType")} className="sort">⬇</span>
          </th>
          <th className="thead">
          ...
          <th className="thead">
            ...
            <span onClick={()=>sortFunction("latest")} className="sort">⬇</span>
          </th>
        </tr>
